...
Descent from Arkov's Tower makes the Steamworkshop available to require and share mods. This is a service which Steam offers to all its customers.
...
Subscribing a mod allows you to play that mod. By subscribing a mod you will make it visible in your Modmanager.

Lets subscribe a mod.
...
This mod is now available on your computer, but not yet ready to play. In order to enable the mod you need to select it, in the Dropdown you then "enable" the mod. Alternativly you can also enable it using the checkbox. In both cases it should afterwards look like the picture bellow.
